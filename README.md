...
[![build-ublue](https://github.com/lephyrus/ublue-os-base/actions/workflows/build.yml/badge.svg)](https://github.com/lephyrus/ublue-os-base/actions/workflows/build.yml)
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/lephyrus/ublue-os-base:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/lephyrus/ublue-os-base:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/lephyrus/ublue-os-base:20230403
```
